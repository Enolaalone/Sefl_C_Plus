...
void InitTimer0(){
	TMOD = 0x01;//启用定时器0
	TH0=(65535-20000)/256;//计时器高八位
	TL0=(65535-20000)%256;//计时器低八位
	ET0=1;//计时器0开关
	EA=1;//中断总开关
	TR0=1;//启动
}
void InitTimer3(){
	TMOD = 0x10;//启用定时器1
	TH1=(65535-50000)/256;//计时器高八位
	TL1=(65535-50000)%256;//计时器低八位
	ET1=1;//计时器0开关
	EA=1;//中断总开关
	TR1=1;//启动
}
void ServiceINTO3() interrupt 3
{
	TH1=(65535-50000)/256;//计时器高八位
	TL1=(65535-50000)%256;//计时器低八位
	switch_lit();
